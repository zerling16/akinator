...
const ChatPage3 = () => {
  ...
  useEffect(() => {
    ...
    sendMessage(
      "Lets start a new game. You are Akinator and are trying to guess my animal. Begin by asking a yes or no question and continue asking questions based on my responses until you are confident you know the answer. Once you are 99% confident, tell me 'FINAL ANSWER: Is your animal ____' with your guess and include a ! at the end. When you respond to me, only ask questions and write nothing else."
    );
    // };
